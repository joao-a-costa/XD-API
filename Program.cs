                ...
                try
                {
                    switch (option)
                    {
                        case "1":
                            ...
                            dynamic order = JsonConvert.DeserializeObject<dynamic>(SampleOrderJson);
                            int nrOrderLines = order["nr_order_lines"];
                            ...
                            break;
                        case "2":
                            examples.GenerateExternalySignedDocument(JsonConvert.DeserializeObject<dynamic>(SampleOrderJson));
                            break;
                        case "3":
